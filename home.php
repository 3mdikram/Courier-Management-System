        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i style="color:green;" class="fa fa-building"></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i style="color:red;" class="fa fa-box"></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i style="color:#009688;" class="fa fa-user"></i>
              </div>
            </div>
          </div>
          <hr>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i style="color:#ff9800;" class="fa fa-box"></i>
              </div>
            </div>
          </div>
            <?php endforeach; ?>
